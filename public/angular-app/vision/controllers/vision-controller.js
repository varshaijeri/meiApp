angular.module('meiApp').controller('visionController',visionController);

function visionController($scope,$translate, $translatePartialLoader,$anchorScroll,$location){
    //var vm = this;
